...
public class ProductosServiceImpl implements ProductosService {
	private static List<Producto> productos=new ArrayList<>(List.of(new Producto(100,"Azucar","Alimentación",1.10,20),
			new Producto(101,"Leche","Alimentación",1.3,10),
			new Producto(102,"Jabón","Limpieza",2,20),
			new Producto(103,"Mesa","Hogar",80,4),
			new Producto(104,"Televisión","Hogar",40,10),
			new Producto(105,"Huevos","Alimentación",3,30),
			new Producto(106,"Fregona","Limpieza",3.40,6),
			new Producto(107,"Detergente","Limpieza",2.5,12)));
	@Override
